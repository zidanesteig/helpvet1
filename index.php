    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      ...
      <div class="android-header mdl-layout__header mdl-layout__header--waterfall">
        <div class="mdl-layout__header-row">
          ...
          <ul class="mdl-menu mdl-js-menu mdl-menu--bottom-right mdl-js-ripple-effect" for="more-button">
            <li class="mdl-list__item"><i class="material-icons">account_circle</i><a  href="https://helpvet.com.br/login_cliente"> Cliente</a></li>
      ...
      <div class="android-drawer mdl-layout__drawer">
        ...
        <nav class="mdl-navigation" style="background: #fff;">
          ...
          <a class="mdl-navigation__link" href="https://helpvet.com.br/login_cliente">Cliente</a>
